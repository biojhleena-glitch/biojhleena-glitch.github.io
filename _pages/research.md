...
<section class="research-direction published-study" aria-labelledby="rna-delivery--endosomal-escape">
  ...
  <figure class="study-figure">
    <a class="study-image" href="{{ '/images/pnas-2021-endosomal-escape.jpg' | relative_url }}" aria-label="View full-size PNAS Figure 2: endosomal escape and gene silencing"><img src="{{ '/images/pnas-2021-endosomal-escape.jpg' | relative_url }}" width="757" height="593" alt="Published microscopy and quantitative results showing nanopiece-mediated siRNA delivery, endosomal escape, gene silencing, and cell viability" loading="lazy" decoding="async"></a>
    <figcaption><strong>From uptake to functional RNA delivery.</strong> Cell imaging and quantitative evaluation of endosomal escape, gene silencing, and viability.<br><span class="figure-credit">Lee et al., <em>PNAS</em> (2021), <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC8126792/#fig02">Figure 2</a>. Reproduced unchanged under <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a>.</span><a class="figure-expand" href="{{ '/images/pnas-2021-endosomal-escape.jpg' | relative_url }}">View full-size figure ↗</a></figcaption>
  </figure>
</section>

<section class="research-direction published-study" aria-labelledby="nanoparticle-design--tissue-transport">
  <div class="study-copy">
  ...
  <figure class="study-figure">
    <a class="study-image" href="{{ '/images/jcr-2025-nanoparticle-design.jpg' | relative_url }}" aria-label="View full-size Journal of Controlled Release Figure 1: nanoparticle design"><img src="{{ '/images/jcr-2025-nanoparticle-design.jpg' | relative_url }}" width="1604" height="2100" alt="Published schematic of Janus base nanotube assembly, doxorubicin loading, computation-aided rod-shaped nanoparticle design, and tumor delivery" loading="lazy" decoding="async"></a>
    <figcaption><strong>From molecular building blocks to tissue delivery.</strong> A published overview of nanotube assembly and computation-aided carrier design.<br><span class="figure-credit">Lee, Zhang et al., <em>Journal of Controlled Release</em> (2025), <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC13382647/#F1">Figure 1</a>. Reproduced unchanged under <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a>.</span><a class="figure-expand" href="{{ '/images/jcr-2025-nanoparticle-design.jpg' | relative_url }}">View full-size figure ↗</a></figcaption>
  </figure>
</section>

<section class="research-direction published-study" aria-labelledby="combination-therapy--cancer-models">
  <div class="study-copy">
  ...
  <figure class="study-figure">
    <a class="study-image" href="{{ '/images/mta-2026-combination-delivery.jpg' | relative_url }}" aria-label="View full-size Materials Today Advances Figure 1: drug and siRNA co-delivery"><img src="{{ '/images/mta-2026-combination-delivery.jpg' | relative_url }}" width="1800" height="1750" alt="Published schematic of doxorubicin and siRNA loading into Janus base nanomaterials and the proposed intracellular delivery mechanism in ovarian cancer models" loading="lazy" decoding="async"></a>
    <figcaption><strong>Combining chemotherapy with gene silencing.</strong> A published schematic of drug and siRNA co-delivery and the proposed mechanism studied in preclinical models.<br><span class="figure-credit">Zhai et al., <em>Materials Today Advances</em> (2026), <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC13322303/#F1">Figure 1</a>. Reproduced unchanged under <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a>.</span><a class="figure-expand" href="{{ '/images/mta-2026-combination-delivery.jpg' | relative_url }}">View full-size figure ↗</a></figcaption>
  </figure>
</section>
