...
eyebrow: Learning through research
permalink: /mentoring/
intro: Preparing researchers to ask clear questions, interpret evidence, and grow in independence.
---
...
<div class="mentoring-grid"><div><span class="direction-number">01</span><h3>Start with the question</h3><p>Help trainees connect experimental choices to a clear biological or materials question, and understand what the results can and cannot establish.</p></div><div><span class="direction-number">02</span><h3>Build a strong foundation</h3><p>Support careful synthesis, characterization, documentation, and analysis so that practical confidence grows alongside scientific judgment.</p></div><div><span class="direction-number">03</span><h3>Develop a scientific voice</h3><p>Encourage increasing ownership of experimental plans and interpretation, with opportunities to explain findings through presentations and writing.</p></div></div>
