...
The current design pairs Georgia display headings with Helvetica-style body text, a warm paper background, teal accents, and a portrait-led introduction. The homepage introduces the researcher, selected experience, a visual research narrative, three published studies, future directions, and mentoring. The navy research section retains the full square conceptual illustration on desktop and mobile. All active styles are in `assets/css/custom.css`. The original Academic Pages stylesheet is retained as `assets/css/main.css` but is not loaded by this design.
